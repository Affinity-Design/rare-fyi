    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-12 md:gap-24">
          ...
          >
            ...
            <motion.p
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white/40 mt-4"
              style={{
          ...
          >
            <p className="text-[#D4AF37]/80 text-sm uppercase tracking-widest mb-4 font-medium">
              Our Philosophy
            </p>
            ...
            <motion.p
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#D4AF37] mt-4"
              style={{
                fontFamily: "'Cormorant Garamond', Georgia, serif",
                fontStyle: "italic",
              }}
        ...
        <motion.div
          ...
          className="w-full h-px bg-gradient-to-r from-transparent via-[#D4AF37]/50 to-transparent my-16 md:my-24 origin-center"
        />
        ...
        >
          <p className="text-xl md:text-2xl lg:text-3xl text-white/80 leading-relaxed">
            ...
            <span className="text-[#D4AF37] font-semibold">deliberate protection</span>—
